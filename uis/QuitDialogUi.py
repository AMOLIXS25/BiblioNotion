...
################################################################################
## Form generated from reading UI file 'QuitDialogUi.ui'
##
...
class Ui_quit_dialog(object):
    def setupUi(self, quit_dialog):
        if not quit_dialog.objectName():
            quit_dialog.setObjectName(u"quit_dialog")
        quit_dialog.resize(440, 253)
        self.verticalLayout = QVBoxLayout(quit_dialog)
        self.verticalLayout.setSpacing(20)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.top_container = QFrame(quit_dialog)
        ...
        self.bottom_container = QFrame(quit_dialog)
        ...
        QMetaObject.connectSlotsByName(quit_dialog)
    # setupUi

    def retranslateUi(self, quit_dialog):
        quit_dialog.setWindowTitle(QCoreApplication.translate("quit_dialog", u"Dialog", None))
        self.aski_quit_label.setText(QCoreApplication.translate("quit_dialog", u"Etes vous sur de vouloir quitter le logiciel ?", None))
        self.yes_button.setText(QCoreApplication.translate("quit_dialog", u"Oui", None))
        self.no_button.setText(QCoreApplication.translate("quit_dialog", u"Non", None))
    # retranslateUi
